      ...
      <View style={styles.body}>
        ...
        <ScrollView horizontal contentContainerStyle={styles.cardContainer} showsHorizontalScrollIndicator={false}>
          ...
          <View style={[styles.card, styles.disabledCard]}>
            <Image source={require('../assets/icons/television.png')} style={styles.cardIcon} />
            <Text style={styles.cardText}>TV(준비중)</Text>
          </View>

          <View style={[styles.card, styles.disabledCard]}>
            <Image source={require('../assets/icons/refrigerator.png')} style={styles.cardIcon} />
            <Text style={styles.cardText}>냉장고(준비중)</Text>
          </View>

          <View style={[styles.card, styles.disabledCard]}>
            <Image source={require('../assets/icons/washingmachine.png')} style={styles.cardIcon} />
